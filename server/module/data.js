...
checkfile(path.join(__dirname, "..", "..", "private", "data.json"), "{}")

let data = {}

const reload = () => {
    data = JSON.parse(fs.readFileSync(path.join(__dirname, "..", "..", "private", "data.json")).toString())
}

const save = () => {
    fs.writeFileSync(path.join(__dirname, "..", "..", "private", "data.json"), JSON.stringify(data))
}
