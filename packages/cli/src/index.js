...
if (fs.existsSync(output) && !force) {
  console.log(
    `The output file ${output} does already exist and the option -f (--force) is not set.`,
    2
  );
  process.exit(1);
}
