...
export class WebClient {
    ...
    updateUsername(username: any, password: any, newUsername: any): Promise<boolean>;
    updatePassword(username: any, password: any, newPassword: any): Promise<boolean>;
    storeData_u(username: any, password: any, data: any, dataName: any): Promise<boolean>;
    ...
    storeData(username: any, password: any, data: any, dataName: any): Promise<boolean>;
    deleteData(username: any, password: any, dataName: any): Promise<boolean>;
    getData(username: any, password: any, dataName: any, hash?: boolean): Promise<any>;
    allowDataAccess(username: any, password: any, dataName: any, newUser: any): Promise<boolean>;
    disallowDataAccess(username: any, password: any, dataName: any, newUser: any): Promise<boolean>;
