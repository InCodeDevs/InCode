    ...
    render() {
        ...
        Object.keys(templates).forEach(k => {
            ...
            entries.push({
                ...
                callback: () => {
                    ...
                    const preUse = () => {
                        if (!template.verified) {
                            UIManager.ask("<h1 style='text-align: center'>Achtung</h1>" +
                            ...
                            (value: string) => {
                                if (ProjectManager.doesProjectExist(value)) {
                                    UIManager.alert("<h1 style='text-align: center; color: red'>Fehler</h1>" +
                                        "<h4 style='text-align: center;'>Dieser Name ist bereits vergeben!</h4>", use);
                                } else {
                                    if (value.length < 4) {
                                        UIManager.alert("<h1 style='text-align: center; color: red'>Fehler</h1>" +
                                            "<h4 style='text-align: center;'>Der Name ist zu kurz! Er muss mindestens 4 Zeichen lang sein!</h4>", use)
                                    } else {
                ...
                imageURL: template.type === 'monaco' ? 'assets/code-editor.png' : 'https://developers.google.com/blockly/images/logos/logo_only.png'
            })
        })
