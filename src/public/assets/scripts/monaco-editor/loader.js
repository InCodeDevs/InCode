  ...
  var h = (function () {
    ...
    return (
      (a.prototype.record = function (n, p) {
        this._events.push(
          new E(n, p, f.Utilities.getHighPerformanceTimestamp())
        );
      }),
    ...
    return (
      (a.validateConfigurationOptions = function (n) {
        ...
        if (
          ...
          n.baseUrl.length > 0 &&
            (f.Utilities.endsWith(n.baseUrl, "/") || (n.baseUrl += "/")),
    ...
    return (
      ...
      (a.prototype._applyPaths = function (n) {
        for (var p, r = 0, e = this.sortedPathsRules.length; r < e; r++)
          if (
            ((p = this.sortedPathsRules[r]), f.Utilities.startsWith(n, p.from))
          ) {
      ...
      (a.prototype._addUrlArgsToUrl = function (n) {
        return f.Utilities.containsQueryString(n)
        ...
        if (!f.Utilities.endsWith(r, ".js") && !f.Utilities.isAbsolutePath(r)) {
          ...
          for (var t = 0, i = e.length; t < i; t++)
            (this.isBuild() && e[t] === "empty:") ||
              (f.Utilities.isAbsolutePath(e[t]) ||
                (e[t] = this.options.baseUrl + e[t]),
              !f.Utilities.endsWith(e[t], ".js") &&
                !f.Utilities.containsQueryString(e[t]) &&
                (e[t] = e[t] + ".js"));
        } else
          !f.Utilities.endsWith(r, ".js") &&
            !f.Utilities.containsQueryString(r) &&
            (r = r + ".js"),
            (e = [r]);
      ...
      (a.prototype.requireToUrl = function (n) {
        var p = n;
        return (
          f.Utilities.isAbsolutePath(p) ||
            ((p = this._applyPaths(p)[0]),
            f.Utilities.isAbsolutePath(p) || (p = this.options.baseUrl + p)),
      ...
      return (
        (r.prototype.load = function (e, t, i, o) {
          var u = e.getConfig().getOptionsLiteral().trustedTypesPolicy,
            s =
              /^((http:)|(https:)|(file:))/.test(t) &&
              t.substring(0, self.origin.length) !== self.origin;
          if (!s) {
            fetch(t)
              .then(function (l) {
      ...
      return (
        ...
        (r.prototype._initNodeRequire = function (e, t) {
          ...
          u.prototype._compile = function (l, c) {
            ...
            return (
              o._handleCachedData(b, d, _, !y.cachedData, t),
              o._verifyCachedData(b, d, _, m, t),
              R
            );
          };
        }),
        ...
        (r.prototype._createAndWriteCachedData = function (e, t, i, o) {
          var u = this,
            ...
            v = function () {
              setTimeout(function () {
                d ||
                  (d = u._crypto.createHash("md5").update(t, "utf8").digest());
          ...
          if (!t) this._fs.readFile(e, { encoding: "utf8" }, o);
            ...
            this._fs.readFile(e, { encoding: "utf8" }, function (v, _) {
              ...
              this._fs.readFile(t, function (v, _) {
                !v && _ && _.length > 0
                  ? ((l = _.slice(0, 16)), (s = _.slice(16)), i.record(60, t))
                  : i.record(61, t),
                  d();
              });
          }
  ...
  var E = (function () {
    ...
    return (
      ...
      (r.prototype.resolveModule = function (e) {
        var t = e;
        return (
          f.Utilities.isAbsolutePath(t) ||
            ((f.Utilities.startsWith(t, "./") ||
              f.Utilities.startsWith(t, "../")) &&
  ...
  var h = (function () {
    ...
    return (
      ...
      (r._invokeFactory = function (e, t, i, o) {
        return e.isBuild() && !f.Utilities.isAnonymousModule(t)
          ? { returnedValue: null, producedError: null }
          : e.shouldCatchError()
          ? this._safeInvokeFunction(i, o)
          : { returnedValue: i.apply(f.global, o), producedError: null };
      }),
          ...
          if (typeof this._callback == "function") {
            ...
            (o = u.producedError),
              ...
              !o &&
                ...
                (!this.exportsPassedIn || f.Utilities.isEmpty(this.exports)) &&
  ...
  var p = (function () {
    ...
    return (
        ...
        for (var e = [], t = 0, i = 0, o = this._modules2.length; i < o; i++) {
          ...
          if (!!u) {
            ...
            e[t++] = {
              ...
              path: s,
              defineLocation:
                s && l ? r._findRelevantLocationInStack(s, l) : null,
              dependencies: c,
              shim: null,
              exports: u.exports,
            };
      ...
      (r.prototype.configure = function (e, t) {
        ...
        t
          ? (this._config = new f.Configuration(this._env, e))
          ...
          if (((this._inverseDependencies2[e.id] = null), v))
            for (var s = 0, l = v.length; s < l; s++) {
              ...
              y.unresolvedDependenciesCount--,
                y.unresolvedDependenciesCount === 0 &&
                  this._onModuleComplete(y);
            }
...
(function (f) {
  ...
  function p() {
    ...
    E.isNode && !E.isElectronRenderer
      ...
      : (E.isElectronRenderer || (f.global.define = g), (f.global.require = n));
  }
  (f.init = p),
    (typeof f.global.define != "function" || !f.global.define.amd) &&
      ((h = new f.ModuleManager(
        E,
        f.createScriptLoader(E),
        g,
        n,
